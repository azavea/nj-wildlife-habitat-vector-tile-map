...
tippecanoe --read-parallel -z 14 -Z 12 -f -o /app/tiles/habitat-areas-2017.mbtiles /app/data/features.txt
...
parallel --pipepart -a /app/data/features.txt node /usr/local/src/create-overview-points.js | tippecanoe -rg -Z 6 -z 13 -ad -f -o /app/tiles/habitat-overview-2017.mbtiles
