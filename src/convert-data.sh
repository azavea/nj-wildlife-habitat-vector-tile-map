...
ogr2ogr -overwrite -f 'CSV' ./data/atlantic_coastal_species.csv /app/data/landscape-project-3-3/atlantic_coastal.gdb Envr_hab_ls_v3_3_coastal_sp_01
...
ogr2ogr -overwrite -f 'CSV' ./data/delbay_species.csv /app/data/landscape-project-3-3/delbay.gdb Envr_hab_ls_v3_3_delbay_sp_02
...
ogr2ogr -overwrite -f 'CSV' ./data/piedmont_species.csv /app/data/landscape-project-3-3/piedmont.gdb Envr_hab_ls_v3_3_piedmt_sp_03
...
ogr2ogr -overwrite -f 'CSV' ./data/pinelands_species.csv /app/data/landscape-project-3-3/pinelands.gdb Envr_hab_ls_v3_3_pineld_sp_04
...
ogr2ogr -overwrite -f 'CSV' ./data/skylands_species.csv /app/data/landscape-project-3-3/skylands.gdb Envr_hab_ls_v3_3_skyland_sp_05
...
ogr2ogr -overwrite -f 'CSV' ./data/marine_species.csv /app/data/landscape-project-3-3/marine.gdb Envr_hab_ls_v3_3_marine_sp_06
